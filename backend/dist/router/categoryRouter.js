...
import { createCategoryHandler, deleteCategoryHandler, getCategoryHandler, updateCategoryHandler, } from "../handler/user/categoryHandler.js";
import { authMiddleware } from "../middleware/authMiddleware.js";
const categoryRouter = Router();
categoryRouter.post("/add", authMiddleware, upload.single("image"), createCategoryHandler);
